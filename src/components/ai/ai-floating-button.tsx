  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 right-4 z-30 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full bg-gradient-blue text-white shadow-[0_14px_34px_rgba(0,151,190,0.4)] transition-transform hover:scale-105 active:scale-95 lg:bottom-6 lg:right-6"
      >
        <JaxongirAiMedia videoClassName="rounded-full" />
      </button>
