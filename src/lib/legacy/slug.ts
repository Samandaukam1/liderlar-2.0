 ...
 *
 * liderlar-admin/src/lib/legacy/slug.ts BILAN BIR XIL nusxa. Ikki repo o'rtasida
 * umumiy paket yo'q, import esa admin tomonda, marshrutlash — shu yerda. Ikkala
 * nusxa bir xil ikkita HAQIQIY havolaga qarshi test qilinadi (bu yerda
 * tests/legacy-route.test.ts, admin'da tests/legacy-import.test.ts), shuning
 * uchun qoida bir tomonda o'zgarib ketsa test yiqiladi.
 *
